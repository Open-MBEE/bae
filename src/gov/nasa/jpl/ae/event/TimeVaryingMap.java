...
//    Parameter<Integer> tpInMap = keyForValueAt( value, tI.getValueNoPropagate() );
   ...
   * Note: this class has a natural ordering that is inconsistent with equals.  It should if it returned compareTo(o, true).
   */
  @Override
  ...
  public boolean isApplied( Effect effect, Method method1, Method method2 ) {
    ...
    if ( value != null ) {
      if ( t instanceof Parameter
        ...
        return hasValueAt( value, tryCastTimepoint( t ), false );
